        ...
        <div className="mb-8">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-300 text-lg">Share your compute resources and earn credits</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Card className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-2xl font-bold text-primary">{earnings.today.toFixed(0)} Credits</div>
                  <div className="text-sm text-gray-400">Today's Compute Credits</div>
                </div>
            ...
            <Card className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-2xl font-bold text-green-400">{nodeStatus.tasksCompleted}</div>
            ...
            <Card className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-2xl font-bold text-purple-400">{nodeStatus.reliability}%</div>
